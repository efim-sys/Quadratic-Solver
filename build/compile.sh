g++ -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat \
...
-fstrict-overflow -flto-odr-type-merging -fno-omit-frame-pointer -Wlarger-than=16384 -Wstack-usage=8192 -pie -fPIE -Werror=vla \
...
ute,null,object-size,return,returns-nonnull-attribute,shift,signed-integer-overflow,undefined,unreachable,vla-bound,vptr $1
echo "-------------------------LAUNCHING-------------------------"
./a.out